...
// enqueue css
function busicol_common_custom_css(){
    
    wp_enqueue_style( 'busicol-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= busicol_opt( 'busicol_theme_color' ) != '#131313' ? busicol_opt( 'busicol_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= busicol_opt( 'busicol_book_btn_color' ) != '#131313' ? busicol_opt('busicol_book_btn_color') : '';
		$bookBtnHoverBgColor     	= busicol_opt( 'busicol_book_btn_hvr_bg_color' ) != '#131313' ? busicol_opt('busicol_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = busicol_opt( 'busicol_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = busicol_opt( 'busicol_navbar_bg_color' ) != '#082b49' ? busicol_opt( 'busicol_navbar_bg_color') : '';
		$headerTop_col     		  = busicol_opt( 'busicol_top_header_color' );

		$headerTopBg      		  = busicol_opt( 'busicol_top_header_bg_color');
		$headerBg          		  = busicol_opt( 'busicol_header_bg_color') != '#ffffff' ? busicol_opt( 'busicol_header_bg_color') : '';
		$menuColor          	  = busicol_opt( 'busicol_header_menu_color' ) != '#131313' ? busicol_opt('busicol_header_menu_color') : '';
		$menuHoverColor           = busicol_opt( 'busicol_header_menu_hover_color' ) != '#808080' ? busicol_opt('busicol_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = busicol_opt( 'busicol_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = busicol_opt( 'busicol_header_drop_menu_bg_color' ) != '#ffffff' ? busicol_opt('busicol_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = busicol_opt( 'busicol_dropdown_menu_color' ) != '#131313' ? busicol_opt('busicol_dropdown_menu_color') : '';
		$dropMenuHovColor         = busicol_opt( 'busicol_dropdown_menu_hover_color' ) != '#808080' ? busicol_opt('busicol_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = busicol_opt( 'busicol_footer_widget_bg_color' );
		$footerwHeadColor   	  = busicol_opt('busicol_footer_widget_heading_color');
		$footerwTextColor   	  = busicol_opt('busicol_footer_widget_text_color');
		$footerwanchorcolor 	  = busicol_opt('busicol_footer_widget_anchor_color') != '#ffffff' ? busicol_opt('busicol_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = busicol_opt('busicol_footer_widget_anchor_hover_color') != '#ffffff' ? busicol_opt('busicol_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = busicol_opt('busicol_fof_bg_color');
		$foftonecolor			  = busicol_opt('busicol_fof_textone_color');
		$fofttwocolor			  = busicol_opt('busicol_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = busicol_opt('busicol_footer_widget_anchor_color') != '#9e9e9e' ? busicol_opt('busicol_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .busicol_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .busicol_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'busicol-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'busicol_common_custom_css', 50 );