...
// image default alt
if ( ! function_exists( 'busicol_img_default_alt' ) ) {
	function busicol_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'busicol_img_tag' ) ) {
	function busicol_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = busicol_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'busicol_anchor_tag' ) ) {
	function busicol_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'busicol_heading_tag' ) ) {
	function busicol_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'busicol_paragraph_tag' ) ) {
	function busicol_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'busicol_other_tag' ) ) {
	function busicol_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'busicol_button_element ' ) ) {
	function busicol_button_element( array $args ) {
